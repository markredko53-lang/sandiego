-- ============================================
-- XENO SUIT SYSTEM v4.1 (ИСПРАВЛЕННЫЙ ДЛЯ ИНЖЕКТОРА)
-- ============================================
...
local CoreGui = game:GetService("CoreGui") -- Используем CoreGui для инжектора

local Player = Players.LocalPlayer

-- Ждем, пока персонаж загрузится, чтобы не было nil ошибок
...
-- ============================================
-- СОЗДАНИЕ UI (Патч для CoreGui)
-- ============================================

local function CreateUI()
    local screenGui = Instance.new("ScreenGui")
    screenGui.Name = "XenoUI"
    -- ВАЖНО: Вешаем на CoreGui, а не на PlayerGui, чтобы инжектор видел это всегда
    screenGui.Parent = CoreGui 
    screenGui.ResetOnSpawn = false
    screenGui.IgnoreGuiInset = true
    
    -- ГЛАВНАЯ ПАНЕЛЬ (код тот же)
...
-- ============================================
-- ОСНОВНЫЕ ФУНКЦИИ (ОСТАЛЬНОЕ БЕЗ ИЗМЕНЕНИЙ)
-- ============================================
...
local function notify(message, color)
    ...
    notification.Parent = CoreGui -- Тоже поменяли на CoreGui
...
print("========================================")
print("✅ XENO SYSTEM ЗАГРУЖЕН (Инжектор версия)!")
print("========================================")
